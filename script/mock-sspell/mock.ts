...
async function main() {
    ...
    const address = "0x346F1d297C98C28574742B067b67A80cdA2Dc0d9";
    ...
    const MIM = "0x26FA3fFFB6EfE8c1E69103aCb4044C26B9A106a9";
    ...
    const sSpellToken = new ethers.Contract(MIM, abi, impersonatedSigner);

    await sSpellToken.transfer(signer.address, ethers.utils.parseEther("1000"));
    
    console.log("after this balance", await sSpellToken.balanceOf(signer.address));
}
