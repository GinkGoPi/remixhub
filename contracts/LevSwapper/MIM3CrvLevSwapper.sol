...
contract MIM3CrvLevSwapper {
    ...
    ICurve3Pool constant public THREEPOOL = ICurve3Pool(0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7);
    IERC20 constant public THREECRV = IERC20(0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490);
    ICurveMetaPool public constant MIM3POOL = ICurveMetaPool(0x5a6A4D54456819380173272A5E8E9B9904BdF41B);
    ...
    IERC20 public constant USDA = IERC20(0xC66AB83418C20A65C3f8e83B3d11c8C3a6097b6F);
    ICurveMetaPool public constant USDA3POOL = ICurveMetaPool(0xA77d09743F77052950C4eb4e6547E9665299BecD);
    
    IERC20 public constant USDC = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);

    // ICurveDepositZap public constant DepositZap = ICurveDepositZap(0xA79828DF1850E8a3A3064576f380D90aECDD3359);
    ...
    constructor () {
        USDA.approve(address(USDA3POOL), type(uint).max);
    ...
    function deposit(uint256 _amount, uint256 _leverage) external returns (uint margin, uint coll, uint debt) {
        ...
        // LUSD -> USDT
        uint256 usdaAmount = depositAmount + expectedBorrow;
        console.log("need lusdAmount", usdaAmount);
        console.log("--> usda balance", USDA.balanceOf(address(this)));

        uint256 dy = USDA3POOL.get_dy_underlying(0, 3, usdaAmount);
        console.log("usdc dy", dy);
        // // uint256 mimUsdtAmount = _mimAmount(_swap, dy);
        uint256 usdtAmount = USDA3POOL.exchange_underlying(0, 3, usdaAmount, dy, address(this));
